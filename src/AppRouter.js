...
import CabList from './components/_Cab/List';
import Main from './components/_Admin/Main';
import CabDetails from './components/_Admin/CabDetails'
      ...
      <div>
          <Router>
            <Switch>
              ...
              <PrivateRoute path='/cablist' component={CabList} />
              <Route path='/adminlogin' component={AdminLogin} />
              <PrivateRouteAdmin path='/main' component={Main} />
              {/* <Route path='/main' component={Main} /> */}
              <PrivateRouteAdmin path='/cabdetails' component={CabDetails} />
