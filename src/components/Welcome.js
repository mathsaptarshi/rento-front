                    ...
                    <Col sm={12}>
                        <section className="fixed full-width blue accent-10 thin-border-bottom" style={{height: '100%'}}>
                            <section className="left-3x absolute top-x">
                                <img src={require("../static/images/tasks-icon-19.png")} alt="Logo" width={50} className="inline"/>                                
                                <span className="white-text" style={{lineHeight:"60px"}}>
                                <label className="logo-font font-4x margin-left-x bold"> Erent</label>
                                <label style={{lineHeight:0}} className="font-1-4x margin-left-2x padding-left-2x block lighter">
                                    Rent a cab easily
                                </label>
                            </span>
                            </section>
                            <article style={{width:500}} className="margin-top-6x padding-5x absolute">
                            ...
                            <article className="width-50 right-off absolute">                                        
                                ...
                                <Row>
                                    <Col sm={12} className="black full-width full-height loader-opacity absolute" style={{left: '12%'}}>
                                            <img src={require("../static/images/UberIM-365.jpg")} 
                        ...
                        <Col sm={3}>
                            <Card className="hvr-grow-shadow bg-color-white" style={{width: '100%'}}>
                                <CardBody>
                                    ...
                                    <div className="">
                                        <img src={require("../static/images/24hour.png")} width="50%" height="40%" className="margin-left-5x box-shadow" alt=""/>
                                    </div>

                                    <CardText className="grey-text font-weight-bolder text-center">We are here to assist you 24/7.Fell free to call, Happy to help You</CardText>
                                    <Row className="green accent-4">
                                        <Col>
