...
// notify = () => toast("Wow so easy to rent your cab!");
componentDidMount() {
...
signIn = (e) => {    
  ...
  if(Validation.emailValidate(this.state.loginFormData.email) &&
    ...
    //   });
      ...
      toast("one or more required field are missing");
      this.setState({loginMsg: 'one or more required field are missing'})
...
addUser = () => {
  ...
  if( 
      ...
      Validation.stringValidate(state.signUpFromData.address) ){
        ...
        // console.log("with license",signUpFromData);
