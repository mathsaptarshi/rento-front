...
class ViewModal extends Component {
    ...
    getTariffByCabType(type){
        // alert(type)              
            this.props.gettarifbycabtype(type).then((response) => {
            const res = response;
            // console.log(res);
                                            ...
                                            <CardBody>
                                                <div className="row">
                                                    ...
                                                    <div className="col-5 float-right">
                                                        <img className="collap-img-style" src={require("../../static/images/two.png")} alt="Card image cap" />
                                                    </div>
