...
class CabList extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            modal: false,
    ...
    resetFilter = () => {
        this.setState({   
                                cabDetailsCopy : this.state.cabDetails,
                                maxPrice: '',
                                minPrice: '',
                                selectValue: '',
                                msg:'' });
                            ...
                            {this.state.cabDetailsCopy.map((val, i) =>
                                <Col key={i} sm="3"className="margin-bottom-2x animated fadeIn">  {/*hvr-grow*/}
                                    ...
                                    <Card className="box-shadow" style={{width: '100%'}} >
                                       ...
                                       <CardImg top width="100%" src={require("../../static/images/two.png")} alt="Card image cap" />
                                        <CardBody>
